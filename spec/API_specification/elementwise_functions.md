...
-   If `x1_i` and `x2_i` have the same mathematical sign, the result has a positive mathematical sign, unless the result is `NaN` (in which case, the "sign" of `NaN` is implementation-defined).
