...
```{note}
The linear algebra functions listed here are required. Additional optional
linear algebra functions are included in the [linear algebra extension](linear-algebra-extension).
