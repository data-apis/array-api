...
def fftfreq(n: int, /, *, d: float = 1.0, dtype: Optional[dtype] = None, device: Optional[device] = None) -> array:
    """
...
def rfftfreq(n: int, /, *, d: float = 1.0, dtype: Optional[dtype] = None, device: Optional[device] = None) -> array:
    """
